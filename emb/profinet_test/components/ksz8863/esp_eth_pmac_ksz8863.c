...
ESP_LOGE("Ezhil","%s","Hellllllllllllllllllll");
    /* Check PHY ID */
    ...
    ESP_GOTO_ON_FALSE(id0.family_id == 0x88 && id1.chip_id == 0x03, ESP_FAIL, err, TAG, "wrong chip IsssssssssssD");
   // ESP_LOGE("addressss","%x",ksz8863->addr);
    ESP_LOGE("Ezhilll....","%d",id0.val);
