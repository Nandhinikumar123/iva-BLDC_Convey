...
// ADDED: Include the FreeRTOS Semaphore headers
...
bool dataExchangeRunning{false};
    // ADDED: Mutex to protect the non-thread-safe P-Net C Library
    SemaphoreHandle_t stackMutex;
