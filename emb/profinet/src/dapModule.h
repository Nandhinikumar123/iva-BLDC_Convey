...
namespace profinet
{
    namespace dap
    {
        ...
        constexpr static uint16_t moduleId{                   0x00000002}; /* DAP 2 = ConveyLinx PLC Control With Reduced I/O */
        constexpr static uint16_t submoduleIdIdentity{        0x00000001};


        constexpr static uint16_t submoduleIdInterface1{      0x00000002};
constexpr static uint16_t submoduleIdInterface1Port1{ 0x00000003};
constexpr static uint16_t submoduleIdInterface1Port2{ 0x00000004};
