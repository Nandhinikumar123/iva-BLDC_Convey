    ...
    public partial class MotorControlPanel : UserControl
    {
        ...
        private void StartButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (mainWindow != null && mainWindow.BLLogic != null)
            {
                mainWindow.BLLogic.SendWriteCommand(1, 0x0030, 0x0001);
                Thread.Sleep(50);
                mainWindow.BLLogic.SendWriteCommand(1, 0x0048, 0x0001);

                // ✅ Correct access path
                mainWindow.MainShell?.LeftMdr?.UpdateRunState(true);
                mainWindow.MainShell?.RightMdr?.UpdateRunState(true);
            }
        }
        ...
        private void StopButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (mainWindow != null && mainWindow.BLLogic != null)
            {
                ...
                Thread.Sleep(50);
                mainWindow.BLLogic.SendWriteCommand(1, 0x0048, 0x0000);

                // ✅ Correct access path
                mainWindow.MainShell?.LeftMdr?.UpdateRunState(false);
                mainWindow.MainShell?.RightMdr?.UpdateRunState(false);
            }
        }
        //private void StopButton_Click(object sender, RoutedEventArgs e)
        //{
        ...
        private void DirectionComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (comboBox.SelectedIndex == 0)
            {
                ...
                mainWindow.BLLogic.SendWriteCommand(1, 0x0047, 1);
            }
            else if (comboBox.SelectedIndex == 1)
            {
                // Index 1 is "ANTI-CW"
                // Generates: 01 06 00 47 00 00 39 DE
                mainWindow.BLLogic.SendWriteCommand(1, 0x0047, 0);
            }
        }
    }
}